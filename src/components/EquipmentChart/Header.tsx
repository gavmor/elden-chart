...
export default function EquipmentChartHeader({ loading, itemCount }: HeaderProps) {
  return (
    <header className="bg-slate-800 border-b border-slate-700 p-4 flex items-center justify-between z-10 shadow-md">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold text-white tracking-wide">Elden Ring Equipment Chart</h1>
